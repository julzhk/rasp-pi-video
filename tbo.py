...
class TBOPlayer:
    ...
    def save_list(self):
        ...
        for idx in range(self.playlist.length()):
            ...
            ofile.write(
                '"' + self.playlist.selected_track()[PlayList.LOCATION] + '","' + self.playlist.selected_track()[
                    PlayList.TITLE] + '"\n')
        ofile.close()
        return
    ...
    def show_omx_track_info(self):
        ...
        if self.options.generate_track_info:
            tkMessageBox.showinfo("Track Information",
                                  self.playlist.selected_track()[PlayList.LOCATION] + "\n" + pformat(self.omx.__dict__))
        else:
...
class OptionsDialog(tkSimpleDialog.Dialog):
    ...
    def body(self, master):
        ...
        self.cb_subtitles = Checkbutton(master, text="Subtitles", variable=self.subtitles_var, onvalue="on",
                                        offvalue="off")
        ...
        self.cb_track_info = Checkbutton(master, text="Generate Track Information", variable=self.track_info_var,
...
if __name__ == "__main__":
    ...
    bplayer = TBOPlayer()
    bplayer.start_omx(track='take3n.mp4')
