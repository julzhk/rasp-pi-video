...
MOUSE_LINKED = True
HIDE_MOUSE = True
PHOTO_SENSOR_TRIGGER_ON_GO_DARK = False
...
if FULLSCREEN: 
    ...
    screen = pygame.display.set_mode([int(i*0.5) for i in movie.get_size()])
movie_screen = pygame.Surface([i*2 for i in movie.get_size()]).convert()
print screen
